...
- (void)addJFButton {
    ...
    _button.imageName = @"Frameworks/MHObjCKit.framework/down_arrow_icon1";
    _button.title = @"选择区县";
...
- (void)touchUpJFButtonEnevt:(JFButton *)sender {
    ...
    if (sender.selected) {
        sender.imageName = @"Frameworks/MHObjCKit.framework/down_arrow_icon2";
    }else {
        sender.imageName = @"Frameworks/MHObjCKit.framework/down_arrow_icon1";
    }
