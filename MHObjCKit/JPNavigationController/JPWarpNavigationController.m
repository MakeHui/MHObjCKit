...
static NSString *const kJPWarpNavigationControllerBackImageName = @"Frameworks/MHObjCKit.framework/JPNavigationController.bundle/jp_navigation_controller_back";
