...
#define GetImage(imageName)  [UIImage imageNamed:[@"Frameworks/MHObjCKit.framework/" stringByAppendingString:imageName]]
...
- (void)initHUBViewWithView:(UIView *)view {
	...
	if (_HUD == nil) {
		...
		_HUD.color = [[UIColor alloc] initWithRed:0 green:0 blue:0 alpha:0.38];
		_HUD.customView = cv;
