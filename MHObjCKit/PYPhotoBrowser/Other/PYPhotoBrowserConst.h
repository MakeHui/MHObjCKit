...
/** --------------可修改(在PYConst.m修改)------------- */
#define PYPlaceholderImage [UIImage imageNamed:@"Frameworks/MHObjCKit.framework/PYPhotosView.bundle/placeholderimage"] // 占位图
#define PYLoadFailureImage [UIImage imageNamed:@"Frameworks/MHObjCKit.framework/PYPhotosView.bundle/imageerror"] // 加载失败图(添加在占位图上大小默认为100 * 100)
#define PYAddImage [UIImage imageNamed:@"Frameworks/MHObjCKit.framework/PYPhotosView.bundle/addimage"] // 添加图片图
#define PYDeleteImage [UIImage imageNamed:@"Frameworks/MHObjCKit.framework/PYPhotosView.bundle/deleteimage"] // 删除图片图
