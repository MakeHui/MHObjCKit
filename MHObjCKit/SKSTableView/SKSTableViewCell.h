...
/**
 * The boolean value showing the receiver is indicator or not. The default value of this property is NO.
 */
@property (nonatomic, assign, getter = isHideIndicator) BOOL hideIndicator;
...
/**
 ...
 @param image expandable image
 */
+ (void)setExpandableImage:(UIImage *)image;
